  ...
  return (
    <>
      <main className="bg-gray-700 text-white">
        <div className="container border-2 border-red-600 p-10">
          <div className="border-2 border-red-600 grid grid-cols-1 md:grid-cols-3 gap-5 min-h-[600px] place-items-center py-20 md:py-0 lg:p-20 p-10">
            {/* Text & Social Icons */}
            ...
            <div className="flex justify-center">
              <img
                src={person}
                alt=""
                className="relative lg:right-40  w-[60%] sm:w-[250px] md:w-full max-w-[400px] h-auto sm:h-[200px] md:h-[300px] lg:h-[400px] xl:h-[400px]  "
              />
            </div>
            ...
            <div className="space-y-7  p-5">
              ...
              <h1 className="text-2xl lg:text-3xl">
                Product Designer and Software Developer, based in Nigeria.
              </h1>
              <p className="text-sm leading-6 opacity-70">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Recusandae minus, repudiandae possimus ex unde ducimus qui
                facilis veniam minima autem.
              </p>
